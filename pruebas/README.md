...
| `primera-olla` | de cero: el primer nivel de las habas estrena el primer plato en la hoja de listo y lleva a la olla con un toque. Y esa olla de alguien que sólo sabe las habas: un cuenco que se arrastra con el dedo, sin faenas ni gesto de la olla grande, el aviso y el resumen con el nombre del plato, qué plato sigue, y la medalla de la receta que no se regala. |
