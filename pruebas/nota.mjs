...
for (const [w, h, nombre] of [[390, 844, 'iPhone 14'], [375, 667, 'iPhone SE'], [360, 640, 'Android chico'], [412, 915, 'Pixel']]) {
  ...
  await p.evaluate(() => { localStorage.setItem('fanesca_version_vista', '2.0.0'); localStorage.setItem('fanesca_v1', JSON.stringify({ vistoPortada: true, mapa: 'bolsas', holaVisto: true, mejores: {} })); });
